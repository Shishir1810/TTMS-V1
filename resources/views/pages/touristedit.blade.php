...
<form action="{{route('tourist.update', $touristedit->id)}}  " method="post" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <label >Phone</label>
    <input type="text" class="form-control"  placeholder="Enter phone" name="tourist_phone">
    <label >Email</label>
    ...
    <label >Address</label>
    <input type="text" class="form-control"  placeholder="Enter adress" name="tourist_address">
  </div>
